              ...
              >
                <div>
                  ...
                  <input
                    ...
                    focus:outline-none block w-full rounded-full placeholder-gray-500 bg-gray-100 dark:bg-gray-800 dark:border-gray-600 pl-12 pr-4 h-12 text-gray-600 transition duration-300 invalid:ring-2 invalid:ring-red-400 focus:ring-2 focus:ring-primary
                    "
                ...
                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                  ...
                  <Link
                    to="/signup"
                    className="py-2 font-medium text-cyan-600 hover:underline dark:text-cyan-500"
                  >
                    Sign up
                  </Link>
                </p>
